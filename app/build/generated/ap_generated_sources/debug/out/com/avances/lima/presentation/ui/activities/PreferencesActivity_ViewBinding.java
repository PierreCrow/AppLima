...
public class PreferencesActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public PreferencesActivity_ViewBinding(PreferencesActivity target, View source) {
    this.target = target;
    ...
    target.rlInteres6 = Utils.findRequiredViewAsType(source, R.id.rlInteres6, "field 'rlInteres6'", RelativeLayout.class);
