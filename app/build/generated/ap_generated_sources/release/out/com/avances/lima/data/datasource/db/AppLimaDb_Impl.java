...
import com.avances.lima.data.datasource.db.dao.CountryDao_Impl;
import com.avances.lima.data.datasource.db.dao.DistritNeighborhoodDao;
import com.avances.lima.data.datasource.db.dao.DistritNeighborhoodDao_Impl;
import com.avances.lima.data.datasource.db.dao.EventDao;
import com.avances.lima.data.datasource.db.dao.EventDao_Impl;
...
import com.avances.lima.data.datasource.db.dao.RouteDao_Impl;
import com.avances.lima.data.datasource.db.dao.SuggestedTagDao;
import com.avances.lima.data.datasource.db.dao.SuggestedTagDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(9) {
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        if (! _infoDbPlace.equals(_existingDbPlace)) {
          throw new IllegalStateException("Migration didn't properly handle DbPlace(com.avances.lima.data.datasource.db.model.DbPlace).\n"
                  + " Expected:\n" + _infoDbPlace + "\n"
                  + " Found:\n" + _existingDbPlace);
        }
        ...
        if (! _infoDbInterest.equals(_existingDbInterest)) {
          throw new IllegalStateException("Migration didn't properly handle DbInterest(com.avances.lima.data.datasource.db.model.DbInterest).\n"
                  + " Expected:\n" + _infoDbInterest + "\n"
                  + " Found:\n" + _existingDbInterest);
        }
        ...
        if (! _infoDbDistritNeighborhood.equals(_existingDbDistritNeighborhood)) {
          throw new IllegalStateException("Migration didn't properly handle DbDistritNeighborhood(com.avances.lima.data.datasource.db.model.DbDistritNeighborhood).\n"
        ...
        if (! _infoDbRoute.equals(_existingDbRoute)) {
          throw new IllegalStateException("Migration didn't properly handle DbRoute(com.avances.lima.data.datasource.db.model.DbRoute).\n"
                  + " Expected:\n" + _infoDbRoute + "\n"
                  + " Found:\n" + _existingDbRoute);
        }
        ...
        if (! _infoDbEvent.equals(_existingDbEvent)) {
          throw new IllegalStateException("Migration didn't properly handle DbEvent(com.avances.lima.data.datasource.db.model.DbEvent).\n"
                  + " Expected:\n" + _infoDbEvent + "\n"
                  + " Found:\n" + _existingDbEvent);
        }
        ...
        if (! _infoDbCountry.equals(_existingDbCountry)) {
          throw new IllegalStateException("Migration didn't properly handle DbCountry(com.avances.lima.data.datasource.db.model.DbCountry).\n"
                  + " Expected:\n" + _infoDbCountry + "\n"
                  + " Found:\n" + _existingDbCountry);
        }
        ...
        if (! _infoDbGender.equals(_existingDbGender)) {
          throw new IllegalStateException("Migration didn't properly handle DbGender(com.avances.lima.data.datasource.db.model.DbGender).\n"
                  + " Expected:\n" + _infoDbGender + "\n"
                  + " Found:\n" + _existingDbGender);
        }
        ...
        if (! _infoDbSuggestedTag.equals(_existingDbSuggestedTag)) {
          throw new IllegalStateException("Migration didn't properly handle DbSuggestedTag(com.avances.lima.data.datasource.db.model.DbSuggestedTag).\n"
                  + " Expected:\n" + _infoDbSuggestedTag + "\n"
