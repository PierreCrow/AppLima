...
public class TabHomeRoutesFragment_ViewBinding implements Unbinder {
  private TabHomeRoutesFragment target;

  @UiThread
  public TabHomeRoutesFragment_ViewBinding(TabHomeRoutesFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    TabHomeRoutesFragment target = this.target;
