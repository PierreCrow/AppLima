...
import com.avances.applima.presentation.ui.adapters.FavoritosVerticalListDataAdapter;
...
public class FavoritosFragment extends BaseFragment implements
        View.OnClickListener,
        FavoritosVerticalListDataAdapter.OnFavoritosVerticalListClickListener, PlaceView, MainActivity.LikeAPlaceAddFavorite {
    ...
    private FavoritosVerticalListDataAdapter.OnFavoritosVerticalListClickListener mlistener;
    ...
    void updateList()
    {
        ...
        if (Helper.getUserAppPreference(getContext()).isHasLocation()) {
            ...
            userHasLocation = false;
             ...
             FavoritosVerticalListDataAdapter routesHorizontalDataAdapter = new FavoritosVerticalListDataAdapter(mlistener,getContext(), favoritesPlaces,userHasLocation);
