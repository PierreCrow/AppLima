...
public class ImperdiblesVerticalListDataAdapter extends RecyclerView.Adapter<ImperdiblesVerticalListDataAdapter.ViewHolderPlace> {
...
/*
    ...
    public ImperdiblesVerticalListDataAdapter(OnImperdiblesVerticalListClickListener mlistener, Context context, List<Place> itemsList, boolean userHasLocation) {
