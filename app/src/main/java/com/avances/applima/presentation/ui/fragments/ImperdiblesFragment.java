...
public class ImperdiblesFragment extends BaseFragment implements
        View.OnClickListener,
        ImperdiblesVerticalListDataAdapter.OnImperdiblesVerticalListClickListener, PlaceView {
...
*/
    ...
    public void placeListLoaded(List<Place> places) {
        ...
        ImperdiblesVerticalListDataAdapter routesHorizontalDataAdapter = new ImperdiblesVerticalListDataAdapter(mlistener, getContext(), places, userHasLocation);
