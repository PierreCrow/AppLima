...
public class RutasTematicasVerticalListDataAdapter extends RecyclerView.Adapter<RutasTematicasVerticalListDataAdapter.ViewHolderPlace> {
    ...
    public RutasTematicasVerticalListDataAdapter(OnRutasTematicasVerticalClickListener mlistener, Context context, List<Route> item) {
        this.items = item;
