...
public class RutasTematicasHorizontalListDataAdapter extends RecyclerView.Adapter<RutasTematicasHorizontalListDataAdapter.SingleItemRowHolder> {
    ...
    public RutasTematicasHorizontalListDataAdapter(OnRutasTematicasHorizontalClickListener mlistener,Context context, List<Route> itemsList) {
