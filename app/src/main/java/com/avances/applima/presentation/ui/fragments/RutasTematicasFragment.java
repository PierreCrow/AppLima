...
import com.avances.applima.presentation.ui.adapters.RutasTematicasVerticalListDataAdapter;
...
public class RutasTematicasFragment extends BaseFragment implements
        View.OnClickListener, RouteView,
        RutasTematicasVerticalListDataAdapter.OnRutasTematicasVerticalClickListener{
    ...
    private RutasTematicasVerticalListDataAdapter.OnRutasTematicasVerticalClickListener mlistener;
    ...
    public void routeListLoaded(List<Route> mRoutes) {
        ...
        RutasTematicasVerticalListDataAdapter routesHorizontalDataAdapter = new RutasTematicasVerticalListDataAdapter(mlistener,getContext(), routes);
