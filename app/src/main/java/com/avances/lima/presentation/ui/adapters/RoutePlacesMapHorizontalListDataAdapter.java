...
public class RoutePlacesMapHorizontalListDataAdapter extends RecyclerView.Adapter<RoutePlacesMapHorizontalListDataAdapter.SingleItemRowHolder> {
    ...
    public RoutePlacesMapHorizontalListDataAdapter(OnPlacesMapHorizontalClickListener mlistener, Context context, List<Place> itemsList, boolean userHasLocation) {
    ...
    public SingleItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_route_place_map, null);
