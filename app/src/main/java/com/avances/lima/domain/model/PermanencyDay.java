...
public class PermanencyDay implements Serializable {
    ...
    public PermanencyDay() {
    }

    public PermanencyDay(String id, String nameParameterValue, String detailParameterValue, boolean active) {
        this.id = id;
