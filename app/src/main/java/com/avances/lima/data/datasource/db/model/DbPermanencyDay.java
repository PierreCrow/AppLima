...
@Entity(tableName = "DbPermanencyDay")
public class DbPermanencyDay {
    ...
    public DbPermanencyDay() {
    }

    public DbPermanencyDay(String idCloud, String nameParameterValue, String detailParameterValue, boolean active) {
